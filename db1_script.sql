...
CREATE TABLE events_(
 ...
 (1, 'Концерт группы Мельница', '2020-12-04 20:00', 20,  420, 03, 1900 ),
 (2, 'Концерт группы Poets of the fall', '2021-11-06 20:00', 20,  310 ,03, 1800),
 (3, 'Концерт группы In extremo', '2020-11-15 20:00', 30, 240,  03, 2200 ),
 (4, 'Мирей Матье. Юбилейная программа', '2020-11-25 19:00', 10, 200, 04, 2800 ),
 (5, 'Музыкальный спектакль на льду "Алладин и повелитель огня', '2020-11-01 19:00', 50, 110,05,  800),
 (6, 'Спектакль "Бесприданница"', '2020-09-18 19:00', 60, 140, 06,1200 ),
 (7, 'Спектакль Ревизор', '2020-09-10 18:00', 60, 150,  06, 1200),
 (8, 'Балет "Сильфида"', '2020-08-07 19:30', 80, 190,07, 2000),
 (9, 'Опера "Летучий голландец"', '2020-08-05 19:30', 80,  210, 08, 2200),
 (10, 'Опера "Иоланта"', '2020-08-09 19:00', 80,  230, 08, 1600),
 (11, 'Концерт группы Наив"', '2020-10-01 20:00', 30,  260 ,03, 1500),
 (12, 'Мюзикл "Мастер и Маргарита', '2020-09-11 18:30', 100,  220,  09, 2000);
...
insert into calendar (id_event, date_event, title_, id_location,  premier) values (1, '2020-12-04 20:00', 'Концерт группы Мельница', 20, true);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (12, '2020-09-11 18:30', 'Мюзикл "Мастер и Маргарита', 100, false);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (11, '2020-10-01 20:00', 'Концерт группы Наив"', 30, false);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (10, '2020-08-09 19:00', 'Опера "Иоланта"',  80,  false);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (9, '2020-08-05 19:30', 'Опера "Летучий голландец"', 80, false);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (8, '2020-08-07 19:30', 'Балет "Сильфида"', 80, false);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (7, '2020-09-10 18:00',  'Спектакль Ревизор', 60,  false);
insert into calendar (id_event, date_event, title_, id_location, premier) values (6, '2020-09-18 19:00', 'Спектакль "Бесприданница"', 60,  true);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (5, '2020-11-01 19:00', 'Музыкальный спектакль на льду "Алладин и повелитель огня"', 50,  true);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (4, '2020-11-25 19:00', 'Мирей Матье. Юбилейная программа', 10, false);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (3, '2020-11-15 20:00', 'Концерт группы In extremo', 30, false);
insert into calendar (id_event, date_event, title_, id_location,  premier) values (2, '2021-11-06 20:00', 'Концерт группы Poets of the fall', 20,false);
